...
<style>
    ...
    body[data-ui="glass"] .tabla-reporte tfoot td { color:rgba(0,234,255,0.90) !important; border-top:2px solid rgba(0,234,255,0.30) !important; }
    ...
    <form id="form-filtros-ingresos" method="GET" action="{{ route('reportes.ingresos') }}">
        <div class="filtros-grid">
            ...
            <div class="filtros-acciones">
                ...
                <x-boton-exportar
                    modulo="reporte_ingresos"
                    ruta="{{ route('exportar.reporte-ingresos') }}"
                    :tieneSensibles="true"
                    labelSensibles="Incluir nombre del paciente y documento"
                    advertenciaSensibles="Se exportarán datos de identificación del paciente."
                />
            </div>
        </div>
    </form>
