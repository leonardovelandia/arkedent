...
<div class="sec-card">
    ...
    <div class="sec-body">
        ...
        <div id="duracion-display-evo" style="font-size:.75rem;color:var(--color-principal);margin-top:.25rem;display:none;">
            <i class="bi bi-clock me-1"></i>Duración: <strong id="duracion-texto-evo"></strong>
        </div>
        <script>
        document.addEventListener('DOMContentLoaded', function() {
            var hi = document.querySelector('[name="hora_inicio"]');
            var hf = document.getElementById('hora_fin_evo');
            var disp = document.getElementById('duracion-display-evo');
            var txt  = document.getElementById('duracion-texto-evo');
            function calcDur() {
