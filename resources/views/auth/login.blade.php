...
<head>
    ...
    <title>Acceso al Sistema — {{ $nombreConsultorio ?? config('app.nombre_consultorio', 'Consultorio Odontológico') }}</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .btn-toggle-password:hover { color: var(--color-principal); }
        ...
        .link-olvide:hover { color: var(--color-hover); text-decoration: underline; }
        ...
        .chip-rol-dot.doctora  { background: var(--color-principal); }
        .chip-rol-dot.asistente{ background: #2196F3; }
        .chip-rol-dot.admin    { background: #9C27B0; }
        ...
        @media (max-width: 480px) {
            .panel-derecho { padding: 1.5rem 1.25rem; }
            .login-titulo { font-size: 1.6rem; }
        }
...
<div class="login-wrapper">
    ...
    <div class="panel-derecho">
        ...
        <div class="login-card">
            ...
            <form id="form-login" method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="campo-grupo animar-entrada delay-3">
                    ...
                    <div class="campo-input-wrapper">
                        ...
                        <button type="button" class="btn-toggle-password" id="btn-toggle-pass" aria-label="Mostrar/ocultar contraseña">
            ...
            <div id="hint-usuario" style="display:none;font-size:.75rem;color:var(--color-principal);text-align:center;margin-top:.4rem;font-weight:500;"></div>

            {{-- Pie de página del login --}}
<div class="pie-login animar-entrada delay-5">
    <p>
        Sistema de gestión para
        <a href="#">{{ $config->nombre_consultorio ?? 'Consultorio Odontológico' }}</a>
        · v1.0.0
    </p>
     <p>
        Powered by Arkevix
...
<div style="text-align:center; margin-top:10px;">
    <img src="{{ asset('arkevix.png') }}" alt="Arkevix" style="height:50px; opacity:1;">
</div>
