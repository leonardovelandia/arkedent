...
<style>
    ...
    /* Errores de validación — color contrastante en glass */
    ...
    body[data-ui="glass"] .seccion-header h6 + span[style*="color:#dc2626"],
    body[data-ui="glass"] span[style*="color:#dc2626"] { color: #ff8a8a !important; }

    /* Autorización block */
    .autorizacion-bloque { border-radius:10px; padding:1rem 1.25rem; margin-top:1rem; }
    body:not([data-ui="glass"]) .autorizacion-bloque { background:#F3E8FF; border:1px solid var(--color-principal); }
    body[data-ui="glass"] .autorizacion-bloque { background:rgba(0,234,255,0.06) !important; border:1px solid rgba(0,234,255,0.35) !important; }
    body[data-ui="glass"] .autorizacion-bloque label { color:rgba(0,234,255,0.90) !important; }
    body[data-ui="glass"] .autorizacion-bloque p { color:rgba(255,255,255,0.55) !important; }
