...
<style>
    ...
    body:not([data-ui="glass"]) .plantilla-chip { background:var(--color-muy-claro); border-color:var(--color-muy-claro); color:var(--color-hover); }
    ...
    body[data-ui="glass"] .plantilla-chip { background:rgba(0,234,255,0.08) !important; border:1px solid rgba(0,234,255,0.25) !important; color:rgba(0,234,255,0.90) !important; }
