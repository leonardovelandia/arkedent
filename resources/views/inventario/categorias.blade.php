...
<style>
    ...
    body:not([data-ui="glass"]) .tabla-cat td { color:#374151; border-bottom:1px solid var(--fondo-borde); }
    body:not([data-ui="glass"]) .acc-edit { background:#f3f4f6; color:#374151; }
    ...
    body[data-ui="glass"] .tabla-cat th { color:rgba(0,234,255,0.90) !important; border-bottom:2px solid rgba(0,234,255,0.30) !important; }
    body[data-ui="glass"] .tabla-cat td { color:rgba(255,255,255,0.88) !important; border-bottom:1px solid rgba(255,255,255,0.06) !important; }
    body[data-ui="glass"] .tabla-cat tr:hover td { background:rgba(0,234,255,0.08) !important; }
    body[data-ui="glass"] .acc-edit { background:rgba(255,255,255,0.08) !important; color:rgba(255,255,255,0.85) !important; }
    body[data-ui="glass"] .acc-del { background:rgba(248,113,113,0.15) !important; color:#fca5a5 !important; }
